        ...
        children: [
            ...
            // Here this Protected Routes component to protect the Routes when the user is not logged in so the user doesn't has any access to Cart or Wishlist until he / she logs in.
            {
                ...
                children: [
                    ...
                    // Here we set the path to /profile as a layout and within this layout is it's children such as Account and Orders so we can route to them from inside the /profile page and all of them are protectedRoutes since the parent is set as protectedRoute.
                    {
                        path: "/profile",
