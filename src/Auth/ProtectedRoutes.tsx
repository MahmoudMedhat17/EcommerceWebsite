...
const ProtectedRoutes = () => {
  ...
  // Here we set Outlet means go the rest of the routes of the user is logged in and in our case our protected routes are the Profile, Orders and wishlist and with Outlet we can get access to these routes since the user is logged in successfully.   
  else {
    return <Outlet />
  }
};
