    ...
    return (
        <ProductInfo title={title} image={img} price={price} direction='row'>
            <div className="flex flex-col justify-between gap-2">
                ...
                <button type='button' onClick={handleDeleteItems} className="bg-gray-500 text-white mb-2 px-4 md:px-8 py-2 hover:bg-red-600 duration-300 cursor-pointer rounded-md w-fit">Remove</button>
            </div>
        </ProductInfo>
    )
});
